...
COPY --from=build /usr/lib/x86_64-linux-gnu/libbcc.so.128-NOTFOUND /usr/lib/x86_64-linux-gnu/libbcc.so.128-NOTFOUND
...
COPY --from=build /usr/lib/x86_64-linux-gnu/libbcc_bpf.so.128-NOTFOUND /usr/lib/x86_64-linux-gnu/libbcc_bpf.so.128-NOTFOUND
COPY --from=build /usr/lib/x86_64-linux-gnu/libelf-0.187.so /usr/lib/x86_64-linux-gnu/libelf-0.187.so
